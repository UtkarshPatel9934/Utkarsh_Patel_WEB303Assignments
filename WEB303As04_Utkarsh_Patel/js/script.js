...
$(function () {
    ...
    function fail(){
        ...
        let newTag6 = document.createElement("h2");
        newTag6.innerHTML = "You must allow geolocation in order to use the application....";
        newTag6.style.color = 'DarkRed';
        get_locationhere.append(newTag6);
        // creates a new tag and insert the message in it and finally append the tag to the div in the document...
    }
